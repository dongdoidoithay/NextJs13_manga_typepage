...
const _lbl_domain_Page="welovemanga.xyz";
const _lbl_domain_name="welovemanga.xyz";
const _sb_seo_default_image="https://welovemanga.xyz/bg.jpg";

const _sb_seo_df_title= "✅We Love Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ♈️ welovemanga.xyz";
const _sb_seo_page_default_key= "welovemanga.xyz,We Love Manga, Manga Kiss, Manga, Read Manga, Manga Online, We Love Manga Free, Manga Scans, Free Manga, We Love Manga Online, We Love Manga Japan";
const _sb_seo_page_default_desc= "♏️⛎ We Love Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},welovemanga.xyz,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="Read {name} 🍀 {chapter} {domain} 💓 {nameOther} Read Online";
const _info_name_manga= "Manga: {name}";
const _desc_info_manga= "❤️️💛💚 We Love Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🎃Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ welovemanga.xyz";
const _sb_seo_page_default_key_br= "welovemanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
