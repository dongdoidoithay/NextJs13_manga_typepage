...
const _lbl_domain_Page="kissmanga.lol";
const _lbl_domain_name="kissmanga.lol";
const _sb_seo_default_image="https://kissmanga.lol/bg.jpg";

const _sb_seo_df_title= "⛎♏️Kiss Manga:Translate, Raw, Adult, Comic- Novels Blog Read Online Free ♈️ kissmanga.lol";
const _sb_seo_page_default_key= "kissmanga.lol,kiss Manga, Manga Kiss, Manga, Read Manga, Manga Online, Kiss Manga Free, Manga Scans, Free Manga, Kiss Manga Online, Kiss Manga Japan";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},kissmanga.lol,manga raw,read manga,read manga online,free online manga,Naruto manga";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ kissmanga.lol";
const _sb_seo_page_default_key_br= "kissmanga.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
