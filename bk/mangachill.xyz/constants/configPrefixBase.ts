/* const _host="http://localhost:5093";
const _hostwww="http://www.localhost:5093"; */ 
export const _host="https://www.mangachill.xyz";
export const _hostwww="https://www.mangachill.xyz"; 


export const _Prefix_Root_Manga_Br='mangas';
export const _Prefix_Root_Adult_Br='adults';
