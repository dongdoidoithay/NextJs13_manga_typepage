const _lbl_Name_Page=`<span class="text-sky-400 font-bold">૮ɦเℓℓ</span><span class="text-orange-600 font-bold"> 🅼🅰🅽🅶🅰</span>`;
const _lbl_domain_Page="mangachill.xyz";
const _lbl_domain_name="mangachill.xyz";
const _sb_seo_default_image="https://mangachill.xyz/bg.jpg";

const _sb_seo_df_title= "🚀 Chill Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ✅ ";
const _sb_seo_page_default_key= ",Chill Manga, Manga Kiss, Manga, Read Manga, Manga Online, Chill Manga Free, Manga Scans, Free Manga, Chill Manga Online, Chill Manga Japan";
const _sb_seo_page_default_desc= "🍀🚀 Chill Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _info_name_manga_title="🚀 Chill Read {name} 🍀 {chapter} {domain} 💓 {nameOther} Read Online";
const _info_name_manga= "Manga {name}";
const _desc_info_manga= "❤️️💛💚 Chill Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangachill.xyz";
const _sb_seo_page_default_key_br= "mangachill.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
