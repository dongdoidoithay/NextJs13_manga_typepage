const _lbl_Name_Page=`<span class="text-sky-400 font-bold">🪐MANGA</span><span class="text-orange-600 font-bold">TOP NEW</span>`;
const _lbl_domain_Page="mangatopnew.xyz";
const _lbl_domain_name="mangatopnew.xyz";
const _sb_seo_default_image="https://mangatopnew.xyz/bg.jpg";

const _sb_seo_df_title= "Manga Top New 📄 Read Free English Manga, Português Manga Online- mangatopnew.xyz";
const _sb_seo_page_default_key= "mangatopnew.xyz,Manga Top New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Manga Top New 💯 Read manga online for free ✅ On mangatopnew.xyz you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangatopnew.xyz";
const _sb_seo_page_default_key_br= "mangatopnew.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
