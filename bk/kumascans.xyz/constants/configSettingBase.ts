export const sb_seo_page_default_key= "kumascans.xyz,manga raw,read manga,Panda Manga, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";

const _sb_seo_df_title= "Kuma scans - Read Free English Manga Online 💯 kumascans.xyz";
const _sb_seo_page_default_key= "kumascans.xyz,manga raw,read manga,Panda Manga, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "❶✔️ Kumascans - Read manga online for free ✅. On kumascans.xyz you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
const _lbl_Name_Page=`<span class="text-sky-400 font-bold">Kuma</span>💚<span class="text-orange-600 font-bold">Scan</span>`;
const _lbl_domain_Page="kumascans.xyz";
const _lbl_domain_name="kumascans.xyz";
const _sb_seo_default_image="https://kumascans.xyz/bg.jpg";

//BR
const _sb_seo_df_title_br= "🎃Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ kumascans.xyz";
const _sb_seo_page_default_key_br= "kumascans.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
