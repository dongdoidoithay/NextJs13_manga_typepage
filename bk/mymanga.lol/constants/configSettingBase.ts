const _lbl_Name_Page=`<span class="text-sky-400 font-bold">🄼🅈</span><span class="text-orange-600 font-bold"> 🈵 Manga</span>`;
const _lbl_domain_Page="mymanga.lol";
const _lbl_domain_name="mymanga.lol";
const _sb_seo_default_image="https://mymanga.lol/bg.jpg";

const _sb_seo_df_title= "Reading My Manga | Manga Raw / Translate / Adult Or Comics 🍀 Blog Comics , Novel Translate Online ❇️ mymanga.lol";
const _sb_seo_page_default_key= "mymanga.lol,my manga , MyManga, Mymanga online, reading MyManga, manga free, manga reading fast, manga fast free at mymanga";
const _sb_seo_page_default_desc= "🍀🚀 My Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="Manga {name} {chapter} 👻 {domain} 🔶 {nameOther} new";
const _info_name_manga= "Manga {name}";
const _desc_info_manga= "❤️️💛💚 My Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🎃Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mymanga.lol";
const _sb_seo_page_default_key_br= "mymanga.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
...
const _sb_seo_page_group_key_br= "{groupname} {key},{groupname} {key} Page {page},,manga raw,read manga,read manga online,free online manga,Naruto manga";
