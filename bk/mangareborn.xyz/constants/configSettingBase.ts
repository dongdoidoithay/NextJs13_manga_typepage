...
export const _sb_seo_df_title= "Read Manga Born English Raw|Scan For Free 🏅 mangareborn.xyz";
export const _sb_seo_page_default_key= "mangareborn.xyz,manga raw,read manga,read manga online,manga online,manga 18+, manga yaoi, manga Adult,Claymore manga";
export const _sb_seo_page_default_desc= "🥇 Welcome to the Official Site mangareborn.xyz.🏅 At Manga raw you can read raw manga. manhwa, manhua completely free with english interface.";
 
export const _sb_seo_page_group_title= "🍀Read Manga in Group {groupname} | {key} {domain}";
export const _sb_seo_page_group_desc= "❶✔️ Read your favorite {groupname} by {key} 📖 Page {page} for {domain}";
...
export const _desc_info_manga= "❤️️ Manga {name} News 🍀 Read the latest 💛💚 {nameOther}{chapter} of {name} {auth} at {domain},Mangas {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
export const _sb_seo_default_image="https://mangareborn.xyz/image/bg.jpg";
 ...
 //BR
export const _sb_seo_df_title_br= "🎃Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangareborn.xyz";
export const _sb_seo_page_default_key_br= "mangareborn.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
