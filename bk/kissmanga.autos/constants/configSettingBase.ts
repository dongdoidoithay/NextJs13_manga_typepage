const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA 💓</span><span class="text-orange-600 font-bold">🄺🄸🅂🅂</span>`;
const _lbl_domain_Page="kissmanga.autos";
const _lbl_domain_name="kissmanga.autos";
const _sb_seo_default_image="https://kissmanga.autos/bg.jpg";

const _sb_seo_df_title= "⛎♏️Kiss Manga:Translate, Raw, Adult, Comic- Novels Blog Read Online Free ♈️ kissmanga.autos";
const _sb_seo_page_default_key= "kissmanga.autos,kiss Manga, Manga Kiss, Manga, Read Manga, Manga Online, Kiss Manga Free, Manga Scans, Free Manga, Kiss Manga Online, Kiss Manga Japan";
const _sb_seo_page_default_desc= "♏️⛎ Kiss Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},kissmanga.autos,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="Read {name} 🍀 {chapter} {domain} 💓 {nameOther} Read Online";
const _info_name_manga= "Manga: {name}";
const _desc_info_manga= "❤️️💛💚 Kiss Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ kissmanga.autos";
const _sb_seo_page_default_key_br= "kissmanga.autos,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
