...
const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">𝕓𝕦𝕕𝕕𝕪</span>`;
const _sb_seo_default_image="https://mangabuddy.lol/bg.jpg";
const _lbl_domain_Page="mangabuddy.lol";
const _lbl_domain_name="mangabuddy.lol";

const _sb_seo_df_title= "Buddy ✅ Manga Raw - Translate - Adult And Comics , Blog Comics , Novel Translate Online 🏵 mangabuddy.lol";
const _sb_seo_page_default_key= "mangabuddy.lol,mangabuddy, manga buddy, buddy online, reading manga buddy, buddy free, buddy reading fast, manga fast free at buddy";
const _sb_seo_page_default_desc= "Buddy 🇺🇸 Online Manga Raw /Translate 🇺🇸/ Adult | Comics | Blog Comics | Novel Translate 🇺🇸 Online Free  Daily updates ✅ On mangabuddy.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangabuddy.lol";
const _sb_seo_page_default_key_br= "mangabuddy.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
