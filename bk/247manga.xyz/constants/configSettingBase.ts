...
const _lbl_domain_Page="247manga.xyz";
const _lbl_domain_name="247manga.xyz";
const _sb_seo_default_image="https://247manga.xyz/bg.jpg";

const _sb_seo_df_title= "🚀 247 Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ✅ 247manga.xyz";
const _sb_seo_page_default_key= "247manga.xyz,247 Manga, Manga Kiss, Manga, Read Manga, Manga Online, 247 Manga Free, Manga Scans, Free Manga, 247 Manga Online, 247 Manga Japan";
const _sb_seo_page_default_desc= "🍀🚀 247 Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},247manga.xyz,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="🚀 247 Read {name} 🍀 {chapter} {domain} 💓 {nameOther} Read Online";
const _info_name_manga= "Manga {name}";
const _desc_info_manga= "❤️️💛💚 247 Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ 247manga.xyz";
const _sb_seo_page_default_key_br= "247manga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
