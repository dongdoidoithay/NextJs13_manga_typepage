export const sb_seo_page_default_key= "leitor.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender";

const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">🕊 LEITOR</span>`;
const _lbl_domain_Page="leitor.xyz";
const _lbl_domain_name="leitor.xyz";
const _sb_seo_default_image="https://leitor.xyz/bg.jpg";

const _sb_seo_df_title= "Reading Manga Audult and Scan ,Raw ,Comic English at ✨ leitor.xyz";
const _sb_seo_page_default_key= "leitor.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender";
const _sb_seo_page_default_desc= "✅ Read favorite manga online! Hundreds of high-quality free manga for you, with a list being updated daily";

const _sb_seo_page_group_title= "🔶 Manga Browse by {groupname} | {key} {domain}";
const _sb_seo_page_group_desc= "✨ Love your favorite {groupname} by {key} 📖 Page {page} for {domain}";
...
const _info_name_manga_title="Read Manga {name} {chapter} ✨ {domain} : {nameOther} ✅ Last update";
...
//BR
const _sb_seo_df_title_br= "Union Mangás ✅ Ler mangá Online -  Read Free English Manga Online 💯 leitor.xyz";
const _sb_seo_page_default_key_br= "leitor.xyz,manga raw,read manga,leitor Union Manga, Manga leitor Union, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc_br= "✅ Mais completo e organizado leitor de histórias e Mangás Livre Online em português. On leitor.xyz you can find hundreds of english translated manga which releases online - free daily updates 100% official";
