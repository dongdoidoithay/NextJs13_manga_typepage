...
const _lbl_domain_Page="bibimanga.xyz";
const _lbl_domain_name="bibimanga.xyz";
const _sb_seo_default_image="https://bibimanga.xyz/bg.jpg";

const _sb_seo_df_title= "🚀 BiBi Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ✅ bibimanga.xyz";
const _sb_seo_page_default_key= "bibimanga.xyz,BiBi Manga, Manga Kiss, Manga, Read Manga, Manga Online, BiBi Manga Free, Manga Scans, Free Manga, BiBi Manga Online, BiBi Manga Japan";
const _sb_seo_page_default_desc= "🍀🚀 BiBi Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},bibimanga.xyz,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="🚀 BiBi Read {name} 🍀 {chapter} {domain} 💓 {nameOther} Read Online";
const _info_name_manga= "Manga {name}";
const _desc_info_manga= "❤️️💛💚 BiBi Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ bibimanga.xyz";
const _sb_seo_page_default_key_br= "bibimanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
