const _lbl_Name_Page=`<span class="text-sky-400 font-bold">🅢➋</span><span class="text-orange-600 font-bold"> 🅼🅰🅽🅶🅰</span>`;
const _lbl_domain_Page="s2manga.lol";
const _lbl_domain_name="s2manga.lol";
const _sb_seo_default_image="https://s2manga.lol/bg.jpg";

const _sb_seo_df_title= "🚀 S2 Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ✅ s2manga.lol";
const _sb_seo_page_default_key= "s2manga.lol,S2 Manga, Manga Kiss, Manga, Read Manga, Manga Online, S2 Manga Free, Manga Scans, Free Manga, S2 Manga Online, S2 Manga Japan";
const _sb_seo_page_default_desc= "🍀🚀 S2 Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},s2manga.lol,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="🚀 S2 Read {name} 🍀 {chapter} {domain} 💓 {nameOther} Read Online";
const _info_name_manga= "Manga: {name}";
const _desc_info_manga= "❤️️💛💚 S2 Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🎃Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ s2manga.lol";
const _sb_seo_page_default_key_br= "s2manga.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
