...
const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGÁ</span><span class="text-orange-600 font-bold">🔝 HOST</span>`;
const _lbl_domain_Page="mangahost.lol";
const _lbl_domain_name="mangahost.lol";
const _sb_seo_default_image="https://mangahost.lol/bg.jpg";

const _sb_seo_df_title= "Read Manga Host fast is updated continuously throughout the day at ✯ mangahost.lol";
const _sb_seo_page_default_key= "mangahost.lol,manga raw,read manga,leitor Union Manga, Manga leitor Union, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "✅ Read favorite manga online! 💯 Hundreds of high-quality free manga for you ,manga Scans, Raw, Adult,Echi, Comic DC, Novels, with a list being updated daily. Naruto manga, Bleach manga, One Piece manga and many more...";
...
//BR
const _sb_seo_df_title_br= "er mangá Online 🔛 Leia Mangá Inglês Gratuito Online em mangahost.lol";
const _sb_seo_page_default_key_br= "mangahost.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
