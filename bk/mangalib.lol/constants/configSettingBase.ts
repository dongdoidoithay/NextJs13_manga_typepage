...
export const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">🄻🄸🄱</span>`;
export const _sb_seo_default_image="https://mangalib.lol/bg.jpg";
export const _lbl_domain_Page="mangalib.lol";
export const _lbl_domain_name="mangalib.lol";
 
export const _sb_seo_df_title= "✅ Read Manga Raw - Translate - Adult And Comics , Blog Comics , Novel Translate Online Free 💤 mangalib.lol";
export const _sb_seo_page_default_key= "mangalib.lol,mc manga, mcmanga foods, mc magal, 1 volume manga recommendations, haikyuu x reader manga, x reader manga, levi x reader manga, spy x family manga reader, bnha x reader mafia au, x reader mafia au, x reader mafia, bts x reader mafia, mafia boss x reader, bakugou x reader mafia au, x-men the manga read online";
export const _sb_seo_page_default_desc= "🦜️ Read Manga Raw /Translate 🇺🇸/ Adult | Comics | Blog Comics | Novel Translate 🇺🇸 Online Free  Daily updates. On mangalib.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";
 
export const _sb_seo_page_group_title= "✅ Read Manga in Group {groupname} | {key} {domain}";
export const _sb_seo_page_group_desc= "🦉 Love your favorite  {groupname} by {key} 🔱 Page {page} for {domain}";
export const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},manga raw,read manga,View Comics Online,free online manga,Naruto manga";
...
export const _desc_info_manga= "✅️ Manga {name} News 🥇 Read the latest 🔱 {nameOther}{chapter} of {name} {auth} at {domain},Mangas {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
export const _keyword_info_manga= "{name},Manga {name} {chapter}, Read {name} online, {name}{chapter} online, {name}{nameOther} series, {name} {chapter}, {name} {chapter} scans";
...
export const _desc_view_name_chapter= "Read {name} {chapter} online for free .You reading manga {name}[{nameOther}] {chapter} hot of {auth} at 👻 {domain}. ❇️ Support reading on mobile, tablet, PC.";
export const _keyword_view_name_chapter= "{name} {chapter}, {name} {chapter} of {auth}, Read {name}{nameOther} {chapter} online, {name}-{auth} {chapter} online For Free, {name}|{nameOther} {chapter} scans,{name} {chapter}-{nameOther}";
...
export const _desc_view_chapter= "Read the latest Novel or Manga and Comic <b> {name} {chapter} </b> at <b> {namePage} </b>. Manga <b> {name} </b> is always updated at <b> {namePage} </b>. Dont forget to read the other manga updates. A list of manga collections <b> {namePage} </b> is in the Manga List menu. </p>";
 ...
 //BR
export const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangalib.lol";
export const _sb_seo_page_default_key_br= "mangalib.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
