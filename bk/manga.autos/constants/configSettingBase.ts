...
const _sb_seo_df_title= "Mangas ♓ Translate | Raw | Adult | Comic | Novel | Blog Read Online Free 🌋 manga.autosMangas ";
const _sb_seo_page_default_key= "manga.autos,Panda Manga, Manga Panda, Manga, Read Manga, Manga Online, Mangas Free, Manga Scans, Free Manga, Mangas Online, Mangas Japan";
const _sb_seo_page_default_desc= "✅ Mangas Online 🌋 Manga  Raw - Scan - Translate - Adult - Novel - Comic free daily updates 100% Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},,manga raw,read manga,Mangas online,free online manga,Naruto manga";

const _info_name_manga_title="Read {name} 🍀 {chapter} {domain} 🔶 {nameOther} Read Online";
const _info_name_manga= "Manga {name}";
const _desc_info_manga= "❤️️💛💚 Mangas {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Mangas {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
const _keyword_info_manga= "{name},Mangas {name} {chapter}, Read {name} online, {name}{chapter} online, {name}{nameOther} series, {name} {chapter}, {name} {chapter} scans";
