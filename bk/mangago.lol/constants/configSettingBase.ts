...
export const _lbl_domain_Page="mangaplus.lol";
export const _lbl_domain_name="mangaplus.lol";
export const _sb_seo_default_image="https://mangaplus.lol/bg.jpg";
 
export const _sb_seo_df_title= "Manga Plus ✅ Manga Raw - Translate - Adult And Comics , Blog Comics , Novel Translate Online 🏵 mangaplus.lol";
export const _sb_seo_page_default_key= "mangaplus.lol,mangaplus, manga plus, plus online, reading manga plus, plus free, plus reading fast, manga fast free at plus";
export const _sb_seo_page_default_desc= "Manga Plus 🇺🇸 Online Manga Raw /Translate 🇺🇸/ Adult | Comics | Blog Comics | Novel Translate 🇺🇸 Online Free  Daily updates ✅ On mangaplus.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
export const _desc_view_chapter= "Read the latest Novel or Manga and Comic <b> {name} {chapter} </b> at <b> {namePage} </b>. Manga <b> {name} </b> is always updated at <b> {namePage} </b>. Dont forget to read the other manga updates. A list of manga collections <b> {namePage} </b> is in the Manga List menu. </p>";
 ...
 //BR
export const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangaplus.lol";
export const _sb_seo_page_default_key_br= "mangaplus.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
