const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">👻Golden</span>`;
const _lbl_domain_Page="goldenmangas.xyz";
const _lbl_domain_name="goldenmangas.xyz";
const _sb_seo_default_image="https://goldenmangas.xyz/bg.jpg";

const _sb_seo_df_title= "Golden Manga📄 Read Free English Manga, Português Manga Online- goldenmangas.xyz";
const _sb_seo_page_default_key= "goldenmangas.xyz,Manga Top New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Golden Manga💯 Read manga online for free ✅ On goldenmangas.xyz you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ goldenmangas.xyz";
const _sb_seo_page_default_key_br= "goldenmangas.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
