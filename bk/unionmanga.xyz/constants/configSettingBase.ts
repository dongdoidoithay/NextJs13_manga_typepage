export const sb_seo_page_default_key= "unionmanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender";

const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGÁS</span><span class="text-orange-600 font-bold">👻 UNION</span>`;
const _lbl_domain_Page="unionmanga.xyz";
const _lbl_domain_name="unionmanga.xyz";
const _sb_seo_default_image="https://unionmanga.xyz/bg.jpg";

const _sb_seo_df_title= "Reading Manga Audult and Scan ,Raw ,Comic English at ✨ unionmanga.xyz";
const _sb_seo_page_default_key= "unionmanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender";
...
//BR
const _sb_seo_df_title_br= "Union Mangás ✅ Grátis Online - Aventura,Criancas,Drama,cois at 💯 unionmanga.xyz";
const _sb_seo_page_default_key_br= "unionmanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender";
const _sb_seo_page_default_desc_br= "✅ Você pode ler quadrinhos online em português aqui.A história é atualizada diariamente e é um recurso conveniente para anunciar novas traduções - free daily updates 100% official";
