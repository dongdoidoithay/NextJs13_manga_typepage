...
const _lbl_Name_Page=`<span class="text-sky-400 font-bold">1ST</span><span class="text-orange-600 font-bold">💞KISS</span>`;
const _sb_seo_default_image="https://pandamanga.xyz/bg.jpg";
const _lbl_domain_Page="pandamanga.xyz";
const _lbl_domain_name="pandamanga.xyz";

const _sb_seo_df_title= "Read Manga KISS English |Raw|Scan|Adult|Comics For Free 💯 1stkissmanga.us";
const _sb_seo_page_default_key= "1stkissmanga.us,kiss Manga, Manga kiss, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, 1stkissmanga.us,manga raw,read manga,read manga online,manga online,manga 18+, manga yaoi, manga Adult,Claymore manga";
const _sb_seo_page_default_desc= "💯 Love manga in site 1stkissmanga.us.💞 You can read raw - scan - adult  manga. manhwa, manhua completely free with english interface and many more...";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},1stkissmanga.us,manga raw,read manga,read manga online,free online manga,Naruto manga";

const _info_name_manga_title="Manga {name} 🍀 {chapter} {domain} 🔶 {nameOther} new";
const _info_name_manga= "Manga {name}";
const _desc_info_manga= "Read manga {name} online 👻 Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Read manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
const _keyword_info_manga= "{name},My Manga {name} {chapter}, Read {name} online, {name}{chapter} online, {name}{nameOther} series, {name} {chapter}, {name} {chapter} scans";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ pandamanga.xyz";
const _sb_seo_page_default_key_br= "pandamanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
...
const _info_name_manga_title_br="Mangá {name} Capítulos#{chapter} 💯 {domain} | {nameOther} ✅ Última atualização";
