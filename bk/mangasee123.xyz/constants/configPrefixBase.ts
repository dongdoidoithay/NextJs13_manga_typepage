...
export const _host="https://www.mangasee123.xyz";
export const _hostwww="https://www.mangasee123.xyz";
...
export const _Prefix_Root_Raw='raws';
export const _Prefix_Root_Adult='adults';
export const _Prefix_Root_Dc='comics';
export const _Prefix_Root_Novel='novels';
export const _Prefix_Root_NewsDc='blogs';
