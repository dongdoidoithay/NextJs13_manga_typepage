...
const _lbl_domain_Page="welovemanga.lol";
const _lbl_domain_name="welovemanga.lol";
const _sb_seo_default_image="https://welovemanga.lol/bg.jpg";

const _sb_seo_df_title= "💟 We Love Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ✅ welovemanga.lol";
const _sb_seo_page_default_key= "welovemanga.lol,We Love Manga, Manga Kiss, Manga, Read Manga, Manga Online, We Love Manga Free, Manga Scans, Free Manga, We Love Manga Online, We Love Manga Japan";
const _sb_seo_page_default_desc= "🍀🚀 We Love Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _sb_seo_page_group_key= "{groupname} {key},{groupname} {key} Page {page},welovemanga.lol,manga raw,read manga,read manga online,free online manga,Naruto manga";
...
//BR
const _sb_seo_df_title_br= "🎃Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ welovemanga.lol";
const _sb_seo_page_default_key_br= "welovemanga.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
