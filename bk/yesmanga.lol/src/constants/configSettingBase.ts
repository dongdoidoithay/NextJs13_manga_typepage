...
export const _sb_seo_df_title= "Manga Yes📄 Read Free English Manga, Português Manga Online- yesmanga.lol";
export const _sb_seo_page_default_key= "yesmanga.lol,Manga Update New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
export const _sb_seo_page_default_desc= "Manga Yes💯 Read manga online for free ✅ On yesmanga.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
export const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ yesmanga.lol";
export const _sb_seo_page_default_key_br= "yesmanga.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
