...
export const _sb_seo_df_title= "✅ Read Manga Raw - Translate - Adult And Comics , Blog Comics , Novel Translate Online Free 💤 mangareader.lol";
export const _sb_seo_page_default_key= "mangareader.lol,mc manga, mcmanga foods, mc magal, 1 volume manga recommendations, haikyuu x reader manga, x reader manga, levi x reader manga, spy x family manga reader, bnha x reader mafia au, x reader mafia au, x reader mafia, bts x reader mafia, mafia boss x reader, bakugou x reader mafia au, x-men the manga read online";
export const _sb_seo_page_default_desc= "🦜️ Read Manga Raw /Translate 🇺🇸/ Adult | Comics | Blog Comics | Novel Translate 🇺🇸 Online Free  Daily updates. On mangareader.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
export const _desc_view_chapter= "Read the latest Novel or Manga and Comic <b> {name} {chapter} </b> at <b> {namePage} </b>. Manga <b> {name} </b> is always updated at <b> {namePage} </b>. Dont forget to read the other manga updates. A list of manga collections <b> {namePage} </b> is in the Manga List menu. </p>";
 ...
 //BR
export const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangareader.lol";
export const _sb_seo_page_default_key_br= "mangareader.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
