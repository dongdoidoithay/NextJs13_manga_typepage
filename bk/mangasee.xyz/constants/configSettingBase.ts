const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">🪐 SEE</span>`;
const _lbl_domain_Page="mangasee.xyz";
const _lbl_domain_name="mangasee.xyz";
const _sb_seo_default_image="https://mangasee.xyz/bg.jpg";

const _sb_seo_df_title= "Manga See🦉 Reading content manga, comic, Novel and Blog Online✅ mangasee.xyz";
const _sb_seo_page_default_key= "mangasee.xyz,manga raw,read manga,manga see,manga, Manga, Read Manga 123, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "✅ mangasee.xyz 🦉 Website aggregating content online manga, comic , Novel and blog news daily updates ✅. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangasee.xyz";
const _sb_seo_page_default_key_br= "mangasee.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
