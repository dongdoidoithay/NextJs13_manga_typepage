const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">✯ PANDA</span>`;
const _lbl_domain_Page="pandamanga.net";
const _lbl_domain_name="pandamanga.net";
const _sb_seo_default_image="https://pandamanga.net/bg.jpg";

const _sb_seo_df_title= "Panda Manga Daily Update📄 Read Free English Manga, Português Manga Online- pandamanga.net";
const _sb_seo_page_default_key= "pandamanga.net,Manga Top New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Panda Manga Daily Update💯 Read manga online for free ✅ On pandamanga.net you can find hundreds of english translated manga which releases online - free daily updates 100% official";

const _sb_seo_page_group_title= "✅ Read Manga in Group {groupname} | {key} {domain}";
const _sb_seo_page_group_desc= "🦉 Pandamanga.net | Love your favorite  {groupname} by {key} 🔱 Page {page} for {domain}";
...
const _info_name_manga= "{name} Manga";
const _desc_info_manga= "✅️ Pandamanga.net | Manga {name} News 🥇 Read the latest 🔱 {nameOther}{chapter} of {name} {auth} at {domain},Mangas {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
const _keyword_info_manga= "Pandamanga.net | {name},Manga {name} {chapter}, Read {name} online, {name}{chapter} online, {name}{nameOther} series, {name} {chapter}, {name} {chapter} scans";
...
const _desc_view_name_chapter= "Pandamanga.net | Read {name} {chapter} online for free .You reading manga {name}[{nameOther}] {chapter} hot of {auth} at 👻 {domain}. ❇️ Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ pandamanga.net";
const _sb_seo_page_default_key_br= "pandamanga.net,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
...
const _sb_seo_page_group_desc_br= "Pandamanga.net | Leia ✅ {groupname} por {key} 💯 Página {page} # {domain}";
...
const _info_name_manga_br= "{name} Mangás";
const _desc_info_manga_br= "Pandamanga.net | {name} Mangá 💯 Leia o último {nameOther}{chapter} de {name} {auth} em {domain},Leia mangá {nameOther} online ✅. Suporte a leitura no celular, tablet, PC.";
...
const _desc_view_name_chapter_br= "Pandamanga.net | Mangá {name} {chapter} Online de graça ✅.Você está lendo mangá {name}[{nameOther}] {chapter} quente de {auth} em 💯 {domain}. ✅ Suporte a leitura no celular, tablet, PC.";
const _keyword_view_name_chapter_br= "Pandamanga.net | {name} {chapter}, {name} {chapter} de {auth}, Leia {name}{nameOther} {chapter} online, {name}-{auth} {chapter} online de graça, {name}|{nameOther } {chapter} scans,{name} {chapter} {nameOther}";
