const _lbl_Name_Page=`<span class="text-sky-400 font-bold">манга</span><span class="text-orange-600 font-bold">👻тян</span>`;
const _lbl_domain_Page="manga-chan.xyz";
const _lbl_domain_name="manga-chan.xyz";
const _sb_seo_default_image="https://manga-chan.xyz/bg.jpg";

const _sb_seo_df_title= "Read ManHua fast is updated continuously throughout the day at ✯ manga-chan.xyz";
const _sb_seo_page_default_key= "manga-chan.xyz,manga raw,read manga,read manga online,manga online,manga 18+, manga yaoi, manga Adult,Claymore manga";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ manga-chan.xyz";
const _sb_seo_page_default_key_br= "manga-chan.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
