const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold">🥇 UPDATE</span>`;
const _lbl_domain_Page="mangaupdate.topl";
const _lbl_domain_name="mangaupdate.topl";
const _sb_seo_default_image="https://mangaupdate.topl/bg.jpg";

const _sb_seo_df_title= "Update Manga Daily📄 Read Free English Manga, Português Manga Online- mangaupdate.top";
const _sb_seo_page_default_key= "mangaupdate.top,Manga Top New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Update Manga Daily💯 Read manga online for free ✅ On mangaupdate.top you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangaupdate.top";
const _sb_seo_page_default_key_br= "mangaupdate.top,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
