...
export const _sb_seo_df_title= "Manga Yes📄 Read Free English Manga, Português Manga Online- yesmanga.xyz";
export const _sb_seo_page_default_key= "yesmanga.xyz,Manga Update New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
export const _sb_seo_page_default_desc= "Manga Yes💯 Read manga online for free ✅ On yesmanga.xyz you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
export const _desc_view_chapter= "Read the latest Novel or Manga and Comic <b> {name} {chapter} </b> at <b> {namePage} </b>. Manga <b> {name} </b> is always updated at <b> {namePage} </b>. Dont forget to read the other manga updates. A list of manga collections <b> {namePage} </b> is in the Manga List menu. </p>";
 //BR
export const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ yesmanga.xyz";
export const _sb_seo_page_default_key_br= "yesmanga.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
