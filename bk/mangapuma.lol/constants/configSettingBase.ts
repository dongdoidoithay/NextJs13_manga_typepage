const _lbl_Name_Page=`<span class="text-sky-400 font-bold">ρυɱα</span><span class="text-orange-600 font-bold"> 🅼🅰🅽🅶🅰</span>`;
const _lbl_domain_Page="mangapuma.lol";
const _lbl_domain_name="mangapuma.lol";
const _sb_seo_default_image="https://mangapuma.lol/bg.jpg";

const _sb_seo_df_title= "🚀 Puma Manga: Scan|Raw|Adult|Comic|Novels Blog Read Online Free ✅ ";
const _sb_seo_page_default_key= ",Puma Manga, Manga Kiss, Manga, Read Manga, Manga Online, Puma Manga Free, Manga Scans, Free Manga, Puma Manga Online, Puma Manga Japan";
const _sb_seo_page_default_desc= "🍀🚀 Puma Manga Online Manga  Raw| Scan| Translate| Adult| Novel| Comic free daily updates 100% ✅  Read Free and Dowload";
...
const _desc_info_manga= "❤️️💛💚 Puma Manga {name} online Read the latest {nameOther}{chapter} of {name} {auth} at {domain},Re Manga {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangapuma.lol";
const _sb_seo_page_default_key_br= "mangapuma.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
