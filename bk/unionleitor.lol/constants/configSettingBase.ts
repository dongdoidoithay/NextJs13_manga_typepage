...
const _lbl_Name_Page=`<span class="text-sky-400 font-bold">UNION</span><span class="text-orange-600 font-bold"> LEITOR</span>`;
const _lbl_domain_Page="unionleitor.lol";
const _lbl_domain_name="unionleitor.lol";
const _sb_seo_default_image="https://unionleitor.lol/bg.jpg";

const _sb_seo_df_title= "Union Leitor📄 Read Free English Manga, Português Manga Online- unionleitor.lol";
const _sb_seo_page_default_key= "unionleitor.lol,Manga Update New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Union Leitor💯 Read manga online for free ✅ On unionleitor.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ unionleitor.lol";
const _sb_seo_page_default_key_br= "unionleitor.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
