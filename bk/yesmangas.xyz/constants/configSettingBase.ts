...
const _lbl_Name_Page=`<span class="text-sky-400 font-bold">MANGA</span><span class="text-orange-600 font-bold"> YES</span>`;
const _lbl_domain_Page="yesmangas.xyz";
const _lbl_domain_name="yesmangas.xyz";
const _sb_seo_default_image="https://yesmangas.xyz/bg.jpg";

const _sb_seo_df_title= "Manga Yes📄 Read Free English Manga, Português Manga Online- yesmangas.xyz";
const _sb_seo_page_default_key= "yesmangas.xyz,Manga Update New, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Manga Yes💯 Read manga online for free ✅ On yesmangas.xyz you can find hundreds of english translated manga which releases online - free daily updates 100% official";
...
//BR
const _sb_seo_df_title_br= "🔱 Union Mangás Grátis Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ yesmangas.xyz";
const _sb_seo_page_default_key_br= "yesmangas.xyz,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
