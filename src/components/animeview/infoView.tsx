...
const InfoViewAnime = ({ config, data, loading }: { config: MangaLang, data: any, loading: boolean }) => {
    //novels
    ...
    return (
        <>
            ...
            <div id="read-view" className="mt-2 mx-1 flex flex-col items-center">
                ...
                {data && <iframe className="inline" src={data.source} height="500" width="100%" frameBorder={"0"} scrolling="no" allowFullScreen={true}></iframe>}
            </div>
