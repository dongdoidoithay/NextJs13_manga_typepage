...
export const sb_seo_page_default_key= "mangaupdates.lol,Manga Update, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";


const _lbl_Name_Page=`<span class="text-sky-400 font-bold">🅼🅰🅽🅶🅰</span><span class="text-orange-600 font-bold">💯 Update</span>`;
const _lbl_domain_Page="mangaupdates.lol";
const _lbl_domain_name="mangaupdates.lol";
const _sb_seo_default_image="https://mangaupdates.lol/bg.jpg";

const _sb_seo_df_title= "Manga Update 📄 Read Free English Manga Online at mangaupdates.lol 💯";
const _sb_seo_page_default_key= "mangaupdates.lol,Manga Update, Manga Panda, Manga, Read Manga, Manga Online, Read Manga Free, Manga Scans, Free Manga, Read Manga Online, Read Manga Japan";
const _sb_seo_page_default_desc= "Manga Update 💯 Read manga online for free ✅ On mangaupdates.lol you can find hundreds of english translated manga which releases online - free daily updates 100% official";

const _sb_seo_page_group_title= "✅ Read Manga in Group {groupname} | {key} {domain}";
const _sb_seo_page_group_desc= "💯 Manga your favorite  {groupname} by {key} 🔱 Page {page} for {domain}";
...
const _desc_info_manga= "✅️ Manga {name} News 🥇 Read the latest 🔱 {nameOther}{chapter} of {name} {auth} at {domain},Mangas {nameOther} online ❇️. Support reading on mobile, tablet, PC.";
...
//BR
const _sb_seo_df_title_br= "🔱Manga Update Online - Raw |Translate| Comic | Novels - Blogs at 💯 ✅ mangaupdates.lol";
const _sb_seo_page_default_key_br= "mangaupdates.lol,mangá union, 4koma, acao, adulto, artes marciais, aventura, comedia, criancas, culinaria, demonios, drama, ecchi, escolar, espaco, esportes, fantasia, ficcao, gender bender, harem";
